...
user_cars = []
result = requests.get("http://3.35.19.36:1337/users")
if result.status_code == 200:
    datas = result.json()
    for data in datas:
        user_cars.append(data['user_car'])
...
while cap.isOpened():
    ...
    for i, plate_img in enumerate(plate_imgs):
        ...
        chars = pytesseract.image_to_string(img_result, lang='Hangul')
